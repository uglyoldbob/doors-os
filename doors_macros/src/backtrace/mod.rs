//! Covers the code necessary for backtraces
...
/// the raw tokens).
pub(crate) fn instrument_speculative(item: proc_macro::TokenStream) -> proc_macro::TokenStream {
...
pub(crate) fn instrument_precise(
