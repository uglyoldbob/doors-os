...
del D:\FAT12\v.04\*.bin
del D:\FAT12\v.04\*.o
ECHO Compile the bootsector
NASM -f bin D:\FAT12\v.04\bootload.asm -o D:\FAT12\v.04\botstrap.bin
partcopy D:\Dos_boot.bin 0 200 -f0
partcopy D:\FAT12\v.04\botstrap.bin 0 3 -f0
partcopy D:\FAT12\v.04\botstrap.bin 3e 1c2 -f0 3e
ECHO We will extract our modified bootsector to the FAT12 directory
partcopy -f0 0 200 D:\FAT12\v.04\btstrp2.bin 
...
copy D:\FAT12\v.04\doors.bin D:\disk\floppy\doors.bin

ECHO We will copy the contents of our bootable
ECHO floppy disk to the floppy disk, and to I:\doors.img
D:\bfi -t="144" -f=D:\Doors.img -b=D:\FAT12\v.04\btstrp2.bin D:\disk\floppy\
