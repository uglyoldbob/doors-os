...
pub trait OperatingSystemTrait {
    /// Run a user specified activity for the operating system
...
impl OperatingSystemDetectorTrait for u32 {
    fn detect(&self, _data: &DumpFile, _kernel: &crate::symbols::Symbols<'_>) -> bool {
        true
    }
...
impl OperatingSystemDetector {
    pub fn detect_os(
        data: &DumpFile,
        kernel: &crate::symbols::Symbols<'_>,
